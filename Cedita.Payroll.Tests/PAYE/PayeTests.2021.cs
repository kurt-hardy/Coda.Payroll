    ...
    public partial class PayeTests
    {
        ...
        public void PayeCumulativeCalculations2021()
        {
            var sets = new[]
            {
                new []
                {
                    new { Mode = PayPeriods.Monthly, Gross = 1155.26m, Code = "1257L", Expected = 22.40m },
                    new { Mode = PayPeriods.Monthly, Gross = 1155.27m, Code = "1257L", Expected = 22.60m },
                    new { Mode = PayPeriods.Monthly, Gross = 3692.26m, Code = "1257L", Expected = 530m },
                    new { Mode = PayPeriods.Monthly, Gross = 8758.26m, Code = "1257L", Expected = 1543.20m },
                    new { Mode = PayPeriods.Monthly, Gross = 52681.25m, Code = "1257L", Expected = 19648.80m },
                    new { Mode = PayPeriods.Monthly, Gross = 50000m, Code = "1257L", Expected = 20767.15m },
                    new { Mode = PayPeriods.Monthly, Gross = 15000m, Code = "1257L", Expected = 5031.10m },
                    new { Mode = PayPeriods.Monthly, Gross = 14000.55m, Code = "1257L", Expected = 4581.10m },
                ...
                new []
                {
                    new { Mode = PayPeriods.Weekly, Gross = 267.07m, Code = "1257L", Expected = 5.20m },
                    new { Mode = PayPeriods.Weekly, Gross = 266.07m, Code = "1257L", Expected = 5.20m },
                    new { Mode = PayPeriods.Weekly, Gross = 853.05m, Code = "1257L", Expected = 122.40m },
                    new { Mode = PayPeriods.Weekly, Gross = 2021.09m, Code = "1257L", Expected = 356.20m },
                    new { Mode = PayPeriods.Weekly, Gross = 12157.07m, Code = "1257L", Expected = 4534.24m },
                    new { Mode = PayPeriods.Weekly, Gross = 15000m, Code = "1257L", Expected = 6349.99m },
                    new { Mode = PayPeriods.Weekly, Gross = 242.84m, Code = "1257L", Expected = -287.12m },
                    new { Mode = PayPeriods.Weekly, Gross = 243.83m, Code = "1257L", Expected = -287.11m },
