...
namespace Coda.Payroll.Tests
{
    public partial class PayeTests
    {
        ...
        public void WelshRatePayeCumulativeCalculations2022()
        {
            var sets = new[]
            {
                new []
        ...
        [TestCategory("PAYE Tests"), TestMethod]
        public void WelshRatePayeWk1Calculations2022()
        {
            // Welsh WK1M1 Monthly
            Assert.AreEqual(0m, LegacyShim(39.24m, "C45L", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(0.2m, LegacyShim(39.25m, "C45L", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(625m, LegacyShim(3164.24m, "C45L", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(625.2m, LegacyShim(3164.25m, "C45L", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(4395.96m, LegacyShim(12593.24m, "C45L", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(4372.11m, LegacyShim(12539.25m, "C45L", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(19.8m, LegacyShim(99.99m, "CBR", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(39.6m, LegacyShim(99.99m, "CD0", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(44.55m, LegacyShim(99.99m, "CD1", PayPeriods.Monthly, 1, 0, 0, false, TaxYear));

            // Welsh WK1M1 Weekly
            Assert.AreEqual(0m, LegacyShim(29.05m, "C145L", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(0.2m, LegacyShim(29.06m, "C145L", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(144.4m, LegacyShim(750.06m, "C145L", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(144.4m, LegacyShim(750.07m, "C145L", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(1009m, LegacyShim(2913.06m, "C145L", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(1009.01m, LegacyShim(2913.07m, "C145L", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(20.2m, LegacyShim(101.99m, "CBR", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(40.4m, LegacyShim(101.99m, "CD0", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
            Assert.AreEqual(45.45m, LegacyShim(101.99m, "CD1", PayPeriods.Weekly, 1, 0, 0, false, TaxYear));
        }
    }
}
